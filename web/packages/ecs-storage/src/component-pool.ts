...
export class ComponentPool<T extends {}, TEntity extends number = number>
    implements StorageComponentPool<T, TEntity>
{
    readonly dense: T[] = [];
    ...
    private readonly componentConstructor: StorageComponentConstructor<T>;
    private readonly objectPool: ObjectPool<T>;
    private readonly config: Required<ComponentPoolConfig<T>>;

    constructor(constructor: StorageComponentConstructor<T>, config: ComponentPoolConfig<T> = {}) {
