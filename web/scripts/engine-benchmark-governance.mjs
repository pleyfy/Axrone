...
const scenarioBudgets = [
    {
        ...
        maxFirstRenderMedianMs: 120,
        maxSetupMedianMs: 290,
        maxComponentInstantiateMedianMs: 55,
        maxActorCreateMedianMs: 95,
        maxRenderableCreateMedianMs: 160,
    ...
    },
    {
        ...
        maxSetupMedianMs: 290,
        maxComponentInstantiateMedianMs: 52,
        maxActorCreateMedianMs: 95,
        maxRenderableCreateMedianMs: 160,
    ...
    },
    {
        ...
        minRunCount: 3,
        minAverageFpsMean: 3.5,
        maxSetupBuildMedianMs: 210,
        maxFirstRenderMedianMs: 100,
        maxSetupMedianMs: 310,
        maxComponentInstantiateMedianMs: 52,
        maxActorCreateMedianMs: 90,
        maxRenderableCreateMedianMs: 155,
        maxSceneSetupMedianMs: 12,
        requireFpsLeader: true,
        requireFirstRenderLeader: true,
    },
